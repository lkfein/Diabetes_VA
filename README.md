...
# Getting Started
To get started, browse through the two folders within the repository (documentation and data). These folders contain the process of colab, raw data and the data subset. If you need help navigating the folders, come back to this read me file and use the links listed below.
# Contents
